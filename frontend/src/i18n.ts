...
const ar: Record<string, string> = {
  ...
  "Le serveur gratuit se réveille — ça peut prendre jusqu’à une minute après une pause. Merci de patienter.": "الخادم المجاني يستيقظ — قد يستغرق الأمر حتى دقيقة بعد فترة توقف. شكرًا لصبرك.",
  ...
  "Personnel assigné": "الفريق المسند",
  "Retirer de cette classe": "إزالة من هذا القسم",
  "Assigner à cette classe": "إسناد إلى هذا القسم",
  "Assigné à cette classe": "مسند إلى هذا القسم",
  "Non assigné": "غير مسند",
  "Aucun éducateur/trice pour l’instant.": "لا يوجد مربّون بعد.",
  "Supprimer cette classe ? Les enfants et le personnel assignés seront simplement désassignés.": "حذف هذا القسم؟ سيتم فقط إلغاء إسناد الأطفال والفريق المرتبطين به.",
  "Retour": "رجوع",
  ...
  "Résumé de la journée…": "ملخص اليوم…",
  "Ajouter des photos": "إضافة صور",
  "Ajoutez un résumé ou au moins une photo.": "أضف ملخصًا أو صورة واحدة على الأقل.",
  "Humeur": "الحالة المزاجية",
  "Joyeux": "مرح",
  "Calme": "هادئ",
  "Fatigué": "متعب",
  "Journée difficile": "يوم صعب",
  "Publier le résumé du jour": "نشر ملخص اليوم",
  "Résumé du jour": "ملخص اليوم",
  "Repas": "الوجبة",
  ...
  "Aucune communication ce jour.": "لا توجد أي مراسلات في هذا اليوم.",
  "Aujourd’hui": "اليوم",
  ...
  "Envoyez ce lien pour qu’il/elle active son compte :": "أرسل هذا الرابط لتفعيل الحساب:",
  "Annuler l’invitation": "إلغاء الدعوة",
  "Invitations en attente pour cette classe": "دعوات قيد الانتظار لهذا القسم",
  "En attente d’activation du compte": "بانتظار تفعيل الحساب",
  "Mes enfants": "أطفالي",
...
const en: Record<string, string> = {
  ...
  "Déconnexion": "Log out",
  "Chargement…": "Loading…",
  "Le serveur gratuit se réveille — ça peut prendre jusqu’à une minute après une pause. Merci de patienter.": "The free server is waking up — this can take up to a minute after a period of inactivity. Thanks for your patience.",
  ...
  "Personnel assigné": "Assigned staff",
  "Retirer de cette classe": "Remove from this classroom",
  "Assigner à cette classe": "Assign to this classroom",
  "Assigné à cette classe": "Assigned to this classroom",
  "Non assigné": "Not assigned",
  "Aucun éducateur/trice pour l’instant.": "No educators yet.",
  "Supprimer cette classe ? Les enfants et le personnel assignés seront simplement désassignés.": "Delete this classroom? Children and staff assigned to it will simply be unassigned.",
  "Retour": "Back",
  ...
  "Résumé de la journée…": "Summary of the day…",
  "Ajouter des photos": "Add photos",
  "Ajoutez un résumé ou au moins une photo.": "Add a summary or at least one photo.",
  "Humeur": "Mood",
  "Joyeux": "Happy",
  "Calme": "Calm",
  "Fatigué": "Tired",
  "Journée difficile": "Tough day",
  "Publier le résumé du jour": "Post the day's summary",
  ...
  "Aucune communication ce jour.": "No communications this day.",
  "Aujourd’hui": "Today",
  ...
  "Envoyez ce lien pour qu’il/elle active son compte :": "Send this link so they can activate their account:",
  "Annuler l’invitation": "Cancel invitation",
  "Invitations en attente pour cette classe": "Pending invitations for this classroom",
  "En attente d’activation du compte": "Waiting for account activation",
